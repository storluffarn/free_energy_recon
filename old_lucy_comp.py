...
from old_local_lucy import local_lucy,lucy_max,lucy_summed_max, local_lucy2, local_lucy3
...
ax2.set_title(r"Summed max, orig.")
...
fig.suptitle(r"E: {}, Z: {}, T: {}, Zmin: {}, Zmax: {}, runs: {}, \newline ITER: {}, ITER-LOCAL: {}, slack {}".format(E,Z,T,Z_min,Z_max,runs,ITER,ITER_LOCAL,slack))
